...
def hele_Command():
    ...
    top.iconbitmap(icon_path)
    msg = tkk.Message(top, text="关于",bg='#87CEEB',font=('宋体',20))
    msg.place(relx=0,rely=0,relheight=1,relwidth=0.4)
...
def tools_Command():
    ...
    icon_path = os.getcwd() + "\document\\analysis.ico"
    top.iconbitmap(icon_path)
    icon_path = "\"" + os.getcwd() + "\\tools\Rename.py" + "\""
